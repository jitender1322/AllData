        ...
        <>
            ...
            <div className='w-full bg-white h-full relative font-inter  flex justify-center'>
                <div className='w-6/12 h-[550px] absolute -top-16 rounded-3xl bg-white shadow-xl' >
                    <h2 className='font-bold text-3xl text-center pt-7' >Login</h2>
                    ...
                    <p className='text-center m-2 text-sm'><a href="">New user? <span className='text-bgColor'>Create an account</span></a></p>
                </div>
            </div>
        </>
    )
